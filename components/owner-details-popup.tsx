        ...
        <div className="space-y-4">
          ...
          <div className="bg-green-50 border border-green-200 p-3 rounded-lg">
            ...
            <p className="text-xs text-green-700 mt-1">
              This owner has been verified by StayHub
            </p>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-3 rounded-lg">
            <p className="text-xs text-yellow-800">
              <span className="font-medium">Safety Reminder:</span> Always verify property details and meet in safe, public locations. StayHub is not responsible for external transactions.
            </p>
          </div>
        </div>
