...
export default function HotelDetailsPage() {
  ...
  const fetchOwnerDetails = async (ownerId: string) => {
    try {
      const response = await fetch(`/api/users?firebaseId=${ownerId}`)
      if (response.ok) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
      <div className="container mx-auto px-4 py-4 md:py-8">
        ...
        <div className="flex items-center justify-between mb-4 md:mb-6">
          ...
          <Badge variant={hotel.isActive ? "default" : "secondary"} className="lg:hidden">
      ...
      {ownerDetails && (
        <OwnerDetailsPopup
          ...
          ownerDetails={{
            ...
            businessName: ownerDetails.businessInfo?.companyName,
