...
const SystemSettingsSchema = new mongoose.Schema({
  // General settings
  general: {
    siteName: { type: String, default: 'StayHub' },
    siteDescription: { type: String, default: 'Modern hotel booking platform' },
    contactEmail: { type: String, default: 'support@stayhub.com' },
  ...
  email: {
    ...
    fromEmail: { type: String, default: 'noreply@stayhub.com' },
    fromName: { type: String, default: 'StayHub' }
  },
